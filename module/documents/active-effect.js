    ...
    return {
      scriptData: new fields.ArrayField(
        new fields.SchemaField({
          ...
          useActionDef:      new fields.BooleanField({ initial: false }),
          actionDef:         new fields.ObjectField({ nullable: true, initial: null }),
          scope:             new fields.ObjectField({ nullable: true, initial: null }),
        }),
        { initial: [] }
      ),
