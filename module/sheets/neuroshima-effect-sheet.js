...
const NS_CHANGE_KEYS = [
  ...
  { group: "NEUROSHIMA.Effects.Keys.Group.HP", actorTypes: ["character", "npc", "creature"], keys: [
    ...
    { key: "system.encumbrance.max",   label: "NEUROSHIMA.Effects.Keys.MaxLoad" }
  ]},
...
export class NeuroshimaEffectSheet extends BaseEffectSheet {
  ...
  async _onAddActionDef(event, target) {
    ...
    defs.push({
      id: foundry.utils.randomID(), type: "melee", name: "Nowa akcja", img: "", tooltip: "",
      mode: "queue", damage: "—",
      successCost: 1, minDice: 1, maxDice: 3, onHitScript: "",
      resource: null, usage: { oncePerMessage: true }, result: null
    });
